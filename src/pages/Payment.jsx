  ...
  const handlePay = (e) => {
    ...
    setTimeout(() => {
      ...
      const history = JSON.parse(
        localStorage.getItem("monkey_dee_payments") || "[]",
      );
      ...
      <section className="section payment-section">
        <div className="section-inner payment-inner">
          ...
          <div className="stepper">
            {["Select Program", "Payment Details", "Confirmation"].map(
              (label, i) => (
                <div
                  key={i}
                    ...
                    <div className="optional-fees fade-up">
                      ...
                      <div className="optional-grid">
                        {FEES.filter((f) => !f.required).map((f) => (
                          <label
                            key={f.id}
                            className={`optional-item ${optionals[f.id] ? "selected" : ""}`}
                          >
                            <input
                              type="checkbox"
                              checked={optionals[f.id]}
                    ...
                    {payMethod === "paypal" && (
                      <div className="alt-pay-info fade-up">
                        ...
                        <p>
                          ...
                          payment of <strong>${total.toLocaleString()}</strong>{" "}
                          securely.
                        </p>
                      </div>
                    )}
                      ...
                      <div className="alt-pay-info fade-up">
                        ...
                        <div className="bank-details">
                          {[
                            ...
                            ["Account Name", "Monkey Dee Preschool LLC"],
                            ["Account No.", "1234-5678-90"],
                            ["Routing No.", "021000021"],
                            ["Reference", "Your Child's Name + Program"],
                          ].map(([k, v]) => (
                    ...
                    {payMethod === "applepay" && (
                      <div className="alt-pay-info fade-up">
                        ...
                        <p>
                          ...
                          <strong>${total.toLocaleString()}</strong> with Apple
                          Pay.
                        </p>
              ...
              {step === 3 && (
                <div className="pay-panel confirmation-panel pop-in">
                  <div className="conf-success">
                    ...
                    <p>
                      Your tuition for <strong>{prog?.name}</strong> has been
                      received. A receipt has been sent to your email.
                    </p>
                  </div>
                  <div className="conf-details">
                    <div className="cd-row">
                      <span>💳 Transaction ID</span>
                      <strong className="txn-id">
                        {txnId ||
                          "MKD-" +
                            Math.random()
                              .toString(36)
                    ...
                    <div className="cd-row">
                      ...
                      <strong style={{ textTransform: "capitalize" }}>
                        {payMethod === "card" ? "Credit/Debit Card" : payMethod}
                      </strong>
                    </div>
                    <div className="cd-row">
                      <span>📋 Status</span>
                      <strong className="cd-status">✅ Confirmed</strong>
                    </div>
                  </div>
                ...
                {selectedProgram ? (
                  <>
                    ...
                    <div className="os-fees">
                      {FEES.filter((f) => f.required || optionals[f.id]).map(
                        (f) => (
                    ...
                    <div className="payment-logos">
                      {["💳 Visa", "💳 Mastercard", "🅰️ Amex", "🅿️ PayPal"].map(
                        (l) => (
                          <span key={l} className="pay-logo">
                            {l}
                          </span>
                        ),
                      )}
            ...
            {[
              {
                ...
                desc: "256-bit SSL encryption on every transaction. Your data is never stored on our servers.",
              },
              {
                icon: "🔁",
                title: "Instant Receipts",
                desc: "Get a digital receipt within seconds of payment. Downloadable PDF available anytime.",
              },
              {
                icon: "📞",
                title: "Payment Support",
                desc: "Our billing team is available Mon–Fri 9AM–5PM to assist with any payment issues.",
              },
              {
                icon: "📅",
                title: "Flexible Billing",
                desc: "Set up auto-pay monthly or choose to pay term-by-term. Cancel or modify anytime.",
              },
            ].map((t) => (
